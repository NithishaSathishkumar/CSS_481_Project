...
// Main component for Contact us
const ContactUs = () => {
    // Return JSX for the Contact us
    return (
        <>
            {/* Root container for the entire Contact Us section */}
                ...
                <div className="ContactUsMainContent">
                    ...
                    <div className="ContactUsInfo">
                        ...
                        <div>
                            ...
                            {/* Email section with a clickable mailto link */}
                            <div className="IndContent">
                        ...
                        {/* Right column: Large illustrative image */}
                        <div class="imgInfo">
